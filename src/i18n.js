...
const ICHING_MESSAGES = {
  'zh-Hant': {
    ...
    'iching.description': '先由下而上記錄六爻；有動爻時再求變卦。',
    'iching.castTitle': '擲三枚通寶', 'iching.castInstructions': '點按通寶切換字面與滿文面；隨機擲幣會在半秒後自動記錄。',
    'iching.threeCoins': '三枚通寶', 'iching.coinToggle': '第 {{number}} 枚：{{face}}，按下切換',
    'iching.coinHintTitle': '通寶可以點選', 'iching.coinHintBody': '點一下通寶即可切換「通寶・陰」與「滿文・陽」。長按會加速旋轉，達最高速後放手會隨機落定。關閉提示即表示知悉，此裝置不會再顯示。',
    ...
    'iching.castComplete': '六爻已記錄，請看下面的卦象與爻辭。',
    'iching.value.6': '老陰 X · 動爻', 'iching.value.7': '少陽 ‘', 'iching.value.8': '少陰 ‘’', 'iching.value.9': '老陽 O · 動爻',
    'iching.random': '隨機擲三枚', 'iching.randomSpinning': '擲幣中…', 'iching.confirm': '確認此爻', 'iching.randomUnavailable': '此瀏覽器暫時無法提供安全隨機數；仍可手動設定通寶。',
  ...
  'zh-Hans': {
    ...
    'iching.description': '先由下而上记录六爻；有动爻时再求变卦。',
    'iching.castTitle': '掷三枚通宝', 'iching.castInstructions': '点按通宝切换字面与满文面；随机掷币会在半秒后自动记录。',
    'iching.threeCoins': '三枚通宝', 'iching.coinToggle': '第 {{number}} 枚：{{face}}，按下切换',
    'iching.coinHintTitle': '通宝可以点选', 'iching.coinHintBody': '点一下通宝即可切换「通宝・阴」与「满文・阳」。长按会加速旋转，达最高速后放手会随机落定。关闭提示即表示知悉，此设备不会再显示。',
    ...
    'iching.castComplete': '六爻已记录，请看下面的卦象与爻辞。',
    'iching.value.6': '老阴 X · 动爻', 'iching.value.7': '少阳 ‘', 'iching.value.8': '少阴 ‘’', 'iching.value.9': '老阳 O · 动爻',
    'iching.random': '随机掷三枚', 'iching.randomSpinning': '掷币中…', 'iching.confirm': '确认此爻', 'iching.randomUnavailable': '此浏览器暂时无法提供安全随机数；仍可手动设置通宝。',
  ...
  en: {
    ...
    'iching.description': 'Record six lines from bottom to top; moving lines also produce a changed hexagram.',
    'iching.castTitle': 'Cast three coins', 'iching.castInstructions': 'Tap a coin to change faces. A random cast is recorded automatically after half a second.',
    'iching.threeCoins': 'Three coins', 'iching.coinToggle': 'Coin {{number}}: {{face}}. Press to flip',
    'iching.coinHintTitle': 'Tap the coins', 'iching.coinHintBody': 'Tap a coin to switch between its Tongbao and Manchu faces. Hold to accelerate; release at full speed for a random face. Closing this tip acknowledges it; it will not appear again on this device.',
    ...
    'iching.random': 'Cast randomly', 'iching.randomSpinning': 'Coins spinning…', 'iching.confirm': 'Confirm this line', 'iching.randomUnavailable': 'Secure randomness is unavailable in this browser. You can still set the coins manually.',
  ...
  it: {
    ...
    'iching.description': 'Registra sei linee dal basso verso l’alto; le linee mobili producono anche un esagramma mutato.',
    'iching.castTitle': 'Lancia tre monete', 'iching.castInstructions': 'Tocca una moneta per cambiare faccia. Un lancio casuale viene registrato automaticamente dopo mezzo secondo.',
    'iching.threeCoins': 'Tre monete', 'iching.coinToggle': 'Moneta {{number}}: {{face}}. Premi per girarla',
    'iching.coinHintTitle': 'Tocca le monete', 'iching.coinHintBody': 'Tocca una moneta per cambiare tra il lato Tongbao e il lato manciù. Tieni premuto per accelerare; rilascia alla massima velocità per un risultato casuale. Chiudendo questo avviso confermi di aver letto; non comparirà più su questo dispositivo.',
    ...
    'iching.random': 'Lancia a caso', 'iching.randomSpinning': 'Monete in rotazione…', 'iching.confirm': 'Conferma la linea', 'iching.randomUnavailable': 'La casualità sicura non è disponibile in questo browser. Puoi impostare le monete manualmente.',
